...
const items = ref<TimelineItem[]>([
  {
    ...
    description: "Clean fields, dedupe by email against GHL contacts",
    icon: "i-lucide-rocket",
  },
  {
    title: "AI qualification",
    description:
      "OpenAI classifies intent (demo / pricing / support) and assigns a 1–5 score",
  ...
  <UContainer class="max-w-5xl">
    <UPage>
      <h1
        ...
        >
          Route inbound leads from web form into GoHighLevel with AI
          qualification
        </h1>
      ...
      <UPageBody>
        ...
        <div class="bg-green-500/15 border border-green-500 rounded-lg p-4">
          ...
          <UTimeline :default-value="2" :items="items" class="w-96 mb-5" />
